...
public class RadarVisitConcentrationService {

    private final CommercialDistrictRepository districtRepository;
    private final InfluxDBClientWrapper influxDBClientWrapper;

    public RadarVisitConcentrationResponse getVisitConcentrationByDistrictUuid(Integer districtUuid) {
        // MySQL에서 상권 이름 조회
        ...
        // Return the response
        return new RadarVisitConcentrationResponse(formattedValue);
    }
